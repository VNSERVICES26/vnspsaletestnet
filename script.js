...
const presaleAddress = "0x730675e567fb9444a9ae543E51b74946739984E3";
...
window.addEventListener('load', async () => {
  if (typeof window.ethereum !== 'undefined') {
    ...
    document.getElementById('buyVNS').addEventListener('click', buyVNS);
    document.getElementById('copyAddress').addEventListener('click', copyVNSAddress);
    document.getElementById('vnsAddress').value = vnsAddress;
  } else {
...
function copyVNSAddress() {
  const copyText = document.getElementById('vnsAddress');
  copyText.select();
  copyText.setSelectionRange(0, 99999);
  document.execCommand("copy");
  alert("Copied VNS Address: " + copyText.value);
}
